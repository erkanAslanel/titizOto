$(function () {
    ...
    //$('.proccess').jqTransform({ imgPath: '../images/forms' });
    ...
    $('.onlyNums').autotab_magic().autotab_filter('numeric');
    ...
    $.fn.simpleTabs = function () {
        ...
        $("ul.tabs li").click(function () {
            ...
            var pageName = $('form').attr("action");
            $.cookie(pageName, activeTab);
        ...
        if (pageName != null && pageName != undefined && $.cookie(pageName) != undefined && $.cookie(pageName) != null) {

           
            $("ul.tabs li a[href=" + $.cookie(pageName) + "]").click();
        }
        else {
            //Default Action
